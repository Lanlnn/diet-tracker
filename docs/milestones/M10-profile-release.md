...
本地与开发者工具验收：Java 18 + MySQL 8.0.46 下后端 37/37、小程序 12/12、JavaScript/JSON 静态检查和发布门禁脚本通过；V8 升级、U8 回滚至 V7 和再次升级均成功。微信开发者工具 Nightly 2.02.2607142 普通编译问题面板为 0。个人中心与设置页证据见 [`../evidence/m10/profile-devtools.jpeg`](../evidence/m10/profile-devtools.jpeg)、[`../evidence/m10/settings-devtools.jpeg`](../evidence/m10/settings-devtools.jpeg) 和项目根目录 `design-qa.md`；完整环境与回滚记录见 [`../evidence/review-20260715/`](../evidence/review-20260715/)。
