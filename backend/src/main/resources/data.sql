...
-- 预设食物分类
-- ============================================
INSERT IGNORE INTO food_category (id, name, icon, sort_order, created_at, updated_at) VALUES
(1, '主食', 'rice', 1, NOW(), NOW()),
(2, '肉类', 'meat', 2, NOW(), NOW()),
...
-- 主食 (category_id = 1)
INSERT IGNORE INTO food_item (name, category_id, unit, calories, protein, fat, carbs, created_at, updated_at) VALUES
...
-- 今天：早餐 - 鸡蛋 + 牛奶 + 全麦面包
INSERT IGNORE INTO meal_record (meal_date, meal_type, food_item_id, quantity, unit, record_time, note, created_at, updated_at)
